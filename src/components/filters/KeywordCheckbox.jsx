...
<>
  <li>
    <input type="checkbox" id={keyword} value={keyword} required="" className="hidden peer" onChange={handleChange} />
    <label htmlFor={keyword} className={`${updatedKeywords.includes(keyword)
      ?
